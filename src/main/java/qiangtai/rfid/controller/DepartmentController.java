...
public class DepartmentController {
    ...
    @Operation(summary = "设备多,分页查看部门")
    public Result<?> pageDepartment(@Valid DepartmentQuery departmentQuery) {
        return Result.success(departmentsService.pageDepartment(departmentQuery));
    }
